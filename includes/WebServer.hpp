...
/*   Updated: 2024/03/19 20:11:35 by fbardeau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class WebServer
{
    ...
    private:
        ...
        string executeCGI(const string& scriptPath, const string& request, int clientSocket);
...
std::string executeCGI(const std::string& scriptPath, const std::string& request);
